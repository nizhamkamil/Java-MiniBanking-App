...
public class Withdraw {
    ...
    public void insertWithdraw(String noRekening, String kategori, String idUser, String nominal, String date) throws SQLException {
        ...
        System.out.println("Withdraw == " + stmt);
